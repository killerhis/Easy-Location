...
- (void)showLogoView
{
    ...
    logoImageView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"easylocation_logo"]];
    logoImageView.center = CGPointMake(160.0f, 200.0f);
...
- (void)hideLogoViewAnimated:(BOOL)animated
{
    ...
    if (animated) {
        ...
        self.panelView.center = CGPointMake(600.0f, 200.0f);
...
-(void)animationDidStop:(CAAnimation *)anim finished:(BOOL)flag
{
    ...
    self.panelView.center = CGPointMake(160.0f, 200.0f);
